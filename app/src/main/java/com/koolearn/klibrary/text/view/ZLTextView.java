...
//        LogUtil.i24("size2:" + myCurrentPage.EndCursor.getParagraphIndex() + "/" + myModel.getParagraphsNumber());
 ...
 //private void prepareTextLine(ZLTextPage page, ZLTextLineInfo info, int x, int y, int columnIndex)
    // 修改 epub 对齐
     private void prepareTextLine(ZLTextPage page, ZLTextLineInfo info, int x, int y, int columnIndex) {
//        LogUtil.i26("x:" + x + "y:" + y + "maxWidth:" + maxWidth); // x固定,y为每行的坐标
...
//                LogUtil.i26("jfullCorrection1:" + (maxWidth - getTextStyle().getRightIndent(metrics()) - info.Width));
...
//                    LogUtil.i26("jfullCorrection2:" + fullCorrection);
                }
                break;
        ...
        int spaceCounterZH = (endElementIndex - info.RealStartElementIndex) - 1;
        ...
        for (int wordIndex = info.RealStartElementIndex; wordIndex != endElementIndex; ++wordIndex, charIndex = 0) {
            ...
            if (element == ZLTextElement.HSpace) {
//                LogUtil.i26("fullCorrection:" + fullCorrection + " wordOccurred:" + wordOccurred + " spaceCounter:" + spaceCounter);
//                LogUtil.i26("element HSpace:" + element + " " + getTextStyle().isUnderline());
...
//                    LogUtil.i26("spaceCounterEN:" + spaceCounter + "fullCorrection:" + fullCorrection + "spaceLength: " + spaceLength);
                 ...
                 * 中文右侧对齐
                 */
                if (wordOccurred && spaceCounterZH > 0) {
                    final int correction = fullCorrection / spaceCounterZH;
                    final int spaceLength = correction;
                    x += spaceLength;
//                    LogUtil.i26("spaceCounterZH:" + spaceCounterZH + "fullCorrection:" + fullCorrection + "spaceLength: " + spaceLength);
                    fullCorrection -= correction;
//                    wordOccurred = false;
                    --spaceCounterZH;
                }
