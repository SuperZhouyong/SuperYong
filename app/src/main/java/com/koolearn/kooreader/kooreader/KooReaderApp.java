...
//            ZLTextHyphenator.Instance().load(book.getLanguage());
    ...
    public TOCTree getNextTOCElement() {
        ...
        for (TOCTree tree : Model.TOCTree) {
            ...
            LogUtils.d("KooReaderApp", "reference.ParagraphIndex:" + reference.ParagraphIndex);
            LogUtils.d("KooReaderApp", "index:" + index);
            LogUtils.d("KooReaderApp", "tree.getReference().ParagraphIndex:" + tree.getReference().ParagraphIndex);
