...
public final class KooReader extends KooReaderMainActivity implements ZLApplicationWindow {
    ...
    public static void openBookActivityId(Context context, Book book, Bookmark bookmark,String bookid ,String bookname){
        final Intent intent = new Intent(context, KooReader.class);
        intent.setAction(KooReaderIntents.Action.VIEW);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        KooReaderIntents.putBookExtra(intent, book);
        KooReaderIntents.putBookmarkExtra(intent, bookmark);
        //　新加的两个参数
        intent.putExtra(AppConfig.spBookId,bookid);
        intent.putExtra(AppConfig.spBookName,bookname);
        context.startActivity(intent);
    }
    /*public static void openBookActivityBymark(Context context, Book book, Bookmark bookmark,String bookid ,String bookname){
        final Intent intent = new Intent(context, KooReader.class);
        intent.setAction(KooReaderIntents.Action.VIEW);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        KooReaderIntents.putBookExtra(intent, book);
...
//    private volatile long myResumeTimestamp; // 数据同步
    ...
    protected void onCreate(Bundle icicle) {
        ...
        BookName = intent.getStringExtra(AppConfig.spBookName);
        BookId = intent.getStringExtra(AppConfig.spBookId);
        LogUtils.i(AppConfig.spCurrentBook,AppConfig.spBookName+"........"+BookName+"---------"+"........"+BookId+AppConfig.spBookId);
