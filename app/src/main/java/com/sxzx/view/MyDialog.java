...
//        new Dialog(context, isFullScreen() ? android.R.style.Theme_Translucent_NoTitleBar_Fullscreen : android.R.style.Theme_Translucent_NoTitleBar);
        ...
        //AlertDialog.Builder alertDialog = new AlertDialog.Builder(context,android.R.style.Theme_Translucent_NoTitleBar_Fullscreen);
        ...
        dialog.setOnDismissListener(new DialogInterface.OnDismissListener()
        {
            ...
            {
                if(onMyDialogDismissed != null)
                {
                    onMyDialogDismissed.onDismissed();
                }
            }
        });
        dialog.setOnShowListener(new DialogInterface.OnShowListener()
        {
            ...
            {
                if(onMyDialogShow != null)
                {
                    onMyDialogShow.onShow();
                }
            }
        });
     ...
     * 设置提示框中要显示的内容
     */
    public MyDialog setLayout(View layout)
    {
        if (layout != null)
        {
     ...
     * 设置提示框中要显示的内容的布局Id
     */
    public MyDialog setLayoutResourceId(int layoutResourceId)
    {
     ...
     * 设置三角形所在的位置
     */
    public MyDialog setLocation(int[] location)
    {
     ...
     */
    public MyDialog setLocationByAttachedView(View attachedView)
    {
     ...
     */
    public MyDialog setGravity(int gravity)
    {
     ...
     */
    public MyDialog setMatchParent(boolean matchParent)
    {
     ...
     * 距离屏幕左右的边距
     */
    public MyDialog setMarginLeftAndRight(int left, int right)
    {
    ...
    public MyDialog setMarginTopAndBottom(int top, int bottom)
    {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) llContent.getLayoutParams();
     ...
     * 设置触摸对话框外面，对话框是否消失
     */
    public MyDialog setTouchOutsideDismiss(boolean touchOutsideDismiss)
    {
     ...
     * 设置提醒框外部区域的颜色
     */
    public MyDialog setOutsideColor(int color)
    {
     ...
     */
    public MyDialog setAnimationTranslationShow(int direction, int duration, float... values)
    {
     ...
     * @param values    动画移动的位置
     */
    public MyDialog setAnimationTranslationDismiss(int direction, int duration, float... values)
    {
        return setAnimationTranslation(false, direction, duration, values);
    }

    private MyDialog setAnimationTranslation(boolean isShow, int direction, int duration, float... values)
    {
     ...
     * @param values   动画移动的位置
     */
    public MyDialog setAnimationAlphaShow(int duration, float... values)
    {
     ...
     * @param values   动画移动的位置
     */
    public MyDialog setAnimationAlphaDismiss(int duration, float... values)
    {
        return setAnimationAlpha(false, duration, values);
    }

    private MyDialog setAnimationAlpha(boolean isShow, int duration, float... values)
    {
...
//        ObjectAnimator.ofFloat(rlOutsideBackground.findViewById(R.id.rlParentForAnimate), "scaleY", 0.3f, 1.0f).setDuration(500).start();
    ...
    private OnMyDialogDismissed onMyDialogDismissed;

    public MyDialog setOnMyDialogDismissed(OnMyDialogDismissed onMyDialogDismissed)
    {
        this.onMyDialogDismissed = onMyDialogDismissed;
        return this;
    }
     ...
     * Dialog is dismissed
     * */
    public interface OnMyDialogDismissed
    {
        public void onDismissed();
    }

    private OnMyDialogShow onMyDialogShow;

    public MyDialog setOnMyDialogShow(OnMyDialogShow onMyDialogShow)
    {
        this.onMyDialogShow = onMyDialogShow;
        return this;
    }
     ...
     * Dialog is showing
     * */
    public interface OnMyDialogShow
    {
        public void onShow();
    }
